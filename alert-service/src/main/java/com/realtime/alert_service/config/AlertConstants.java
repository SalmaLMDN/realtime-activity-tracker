...
public class AlertConstants {
    ...
    public static final Set<String> CRITICAL_ACTIONS = Set.of("DELETE_ACCOUNT","TRANSFER_FUNDS");
    public static final int CRITICAL_ACTION_THRESHOLD =3;
    public static final Duration CRITICAL_WINDOW = Duration.ofSeconds(60);
